...
const svelte = function () {
  ...
  const h = [], g = [], y = [], x = [], b = Promise.resolve();
  let v = !1;
  function _(t) {
    y.push(t);
  }
  ...
  class Svelte extends SvelteBase {
    constructor(t) {
      super();
      t.target.addEventListener('click', () => opts.raf = !opts.raf);
      setTimeout(() => S(this, t, M, I, s, {}), 1e3);
    }
  }
