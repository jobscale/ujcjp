...
class App {
  ...
  useHeader() {
    ...
    app.use((req, res, next) => {
      ...
      res.header('Content-Security-Policy', "default-src 'none'; base-uri 'none'; form-action 'self' https:; connect-src https: wss:; font-src 'self' data: https:; frame-src 'self' https:; frame-ancestors 'self'; img-src 'self' data: https:; script-src 'self'; style-src 'self' 'unsafe-inline' https:; prefetch-src 'self'; manifest-src 'self'");
